package com.example.jwtTokenTest.jwt;
...
public class TokenProvider {
    ...
    public TokenDto generateTokenDto(Authentication authenticaion){
        String authorities = authenticaion.getAuthorities().stream()
        ...
        return TokenDto.builder()
                ...
                .accessTokenExpiresln(accessTokenExpiresln.getTime())
                .refreshToken(refreshToken)
                .build();

    }

    public Authentication getAutenticaion(String accessToken){
